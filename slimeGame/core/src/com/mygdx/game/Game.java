...
public class Game extends ApplicationAdapter {
	...
	public void render () {
		...
		float scale2 = Gdx.graphics.getHeight() / 1080f;
		...
		batch.draw(playerImage, player.getBody().getPosition().x * ppm * scale - scale2*playerImage.getWidth() / 2, player.getBody().getPosition().y * ppm * scale - scale2*playerImage.getHeight() / 2 - (camera.position.y - 4.5f) * ppm * scale, Gdx.graphics.getWidth() * 90 / 1920, Gdx.graphics.getHeight() * 61 / 1080);
